...
$qry = "SELECT customers.name AS cname, dispatch.*, dispatchers.dispatcher, techs.name, tech_status.name as tstatus, problems.problem, etas.eta_value FROM dispatch 
LEFT JOIN customers ON (customers.id = dispatch.company_id)
LEFT JOIN dispatchers ON (dispatchers.id = dispatch.dispatcher_id)
LEFT JOIN techs ON (techs.id = dispatch.tech_id)
    	...
    	<td style="padding:5px;" valign="middle">
            ...
            <table width="100%" align="center">
                ...
                <tr bgcolor="<?php echo $warningcolor; ?>">
                    ...
                    <td><a href="#" style="color:#00006F;" onclick="close_dispatch(<?php echo $dispatch["id"]; ?>);"><strong>Close</strong></a></td>
				</tr>
