...
<head>
  ...
  function tabs1_click()
  {
		...
		({
			type: "POST",
			url: "ajax_admin/admin_rejected_dispatches.php",
  ...
  function tabs2_click(did)
  {
		...
		({
			type: "POST",
			url: "ajax_admin/admin_get_rejected_dispatch_form.php",
			data: {id : did},
			success: function(result)
			{
				if (result) 
...
<table width="1300" border="0" cellpadding="0" cellspacing="0" id="cmsborder2" align="center">
	<tr>
    	<td><h1 style="margin-left:20px;">Rejected Dispatches</h1></td>
    </tr>
    <tr>
    	<td style="padding:5px;">
        	<div style="border:1px solid GREEN;" >
               <div id="tabs">
                  <ul>
                  	<li><a href="#tabs-1">Rejected Dispatches</a></li>               
                  </ul>
                  <div id="tabs-1">
                   	<?php include("ajax_admin/admin_rejected_dispatches.php"); ?>
                  </div>
                </div>
 			</div>
        </td>
